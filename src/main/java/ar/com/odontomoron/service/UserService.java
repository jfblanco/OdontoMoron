...
import ar.com.odontomoron.service.util.RandomUtil;
...
public class UserService {
    ...
    public User createUserInformation(String login, String password, String firstName, String lastName, String email,
        ...
        Authority authority = authorityRepository.findOne("ROLE_ADMINISTRADOR");
        if(role.equals("ROLE_ODONTOLOGO"))
            authority = authorityRepository.findOne("ROLE_ODONTOLOGO");
